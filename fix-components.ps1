# Script para arreglar componentes con errores
...
$dashboardContent | Out-File -FilePath "src/app/components/dashboard/dashboard.component.ts" -Encoding UTF8 -NoNewline
$layoutContent | Out-File -FilePath "src/app/components/layout/layout.component.ts" -Encoding UTF8 -NoNewline

Write-Host "Componentes arreglados exitosamente"
